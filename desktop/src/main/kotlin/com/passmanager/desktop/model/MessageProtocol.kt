package com.passmanager.desktop.model
...
sealed interface SecureRequest {
    @Serializable @SerialName("verify")
    data class Verify(val code: String) : SecureRequest

    @Serializable @SerialName("list_items")
    data object ListItems : SecureRequest

    @Serializable @SerialName("get_password")
...
sealed interface SecureResponse {
    @Serializable @SerialName("verify_ok")
    data class VerifyOk(val safetyNumber: String) : SecureResponse

    @Serializable @SerialName("verify_failed")
